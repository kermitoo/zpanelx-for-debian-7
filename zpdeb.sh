...
echo -e ""
echo -e "##############################################################"
echo -e "# Welcome to the UnOfficial ZPanelX Installer for Debian 7   #"
echo -e "# By kermitoo                                                #"
echo -e "#                                                            #"
...
echo -e "# installed Debian 7 with no extra packages.                 #"
echo -e "#                                                            #"
echo -e "# If you selected additional options during the Debian       #"
...
apt-get -y install sudo wget vim make zip unzip git debconf-utils gcc at
...
git clone https://github.com/kermitoo/zpanelx.git
cd zpanelx/
git checkout master
